  ...
  return (
    <div className={style.background}>
      ...
      <div className={style.secondContainer}>
        ...
        {speed !== 0 && (
          <div>
            <h2 className={style.everyDetailStyle}>speed: {speed}</h2>
          </div>
        )}
        {weight !== 0 && (
          <div>
            <h2 className={style.everyDetailStyle}>weight: {weight}</h2>
          </div>
        )}
        {height !== 0 && (
          <div>
            <h2 className={style.everyDetailStyle}>height: {height}</h2>
          </div>
        )}
      </div>
    </div>
